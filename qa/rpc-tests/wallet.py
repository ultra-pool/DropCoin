...
#   c) node1 mines 32 blocks, so now node 0 has 500000DCO, node 1 has 4250DCO, node2 has none.
#   d) node0 sends 601 DCO to node2, in two transactions (301 DCO, then 300 DCO).
