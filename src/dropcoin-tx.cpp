...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DropCoin Core dropcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dropcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded DropCoin transaction") + "\n" +
                               "  dropcoin-tx [options] -create [commands]   " + _("Create hex-encoded DropCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded DropCoin transaction
