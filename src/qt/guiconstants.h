...
/* DropCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DropCoin"
#define QAPP_ORG_DOMAIN "dropcoinproject.io"
#define QAPP_APP_NAME_DEFAULT "DropCoin-Qt"
#define QAPP_APP_NAME_TESTNET "DropCoin-Qt-testnet"
