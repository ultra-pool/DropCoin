...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DropCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DropCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DropCoin features */
        {"dropcoin", "masternode", &masternode, true, true, false},
        {"dropcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"dropcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dropcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dropcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dropcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"dropcoin", "startmasternode", &startmasternode, true, true, false},
        {"dropcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dropcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dropcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dropcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dropcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dropcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dropcoin", "mnbudget", &mnbudget, true, true, false},
        {"dropcoin", "preparebudget", &preparebudget, true, true, false},
        {"dropcoin", "submitbudget", &submitbudget, true, true, false},
        {"dropcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dropcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dropcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dropcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dropcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dropcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dropcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dropcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"dropcoin", "mnsync", &mnsync, true, true, false},
        {"dropcoin", "spork", &spork, true, true, false},
        {"dropcoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"dropcoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"dropcoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"dropcoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"dropcoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"dropcoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> dropcoin-cli " + methodname + " " + args + "\n";
}
