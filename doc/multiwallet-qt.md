...
In order to support loading of multiple wallets in dropcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dropcoin.cpp.
...
Changes to dropcoin.cpp
----------------------
dropcoin.cpp is the entry point into dropcoin-qt, and as such, will require some minor modifications to provide hooks for
