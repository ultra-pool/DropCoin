...
This mechanism has been integrated into Bitcore-Node-DropCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dropcoin/insight-api-dropcoin#web-socket-api](https://github.com/dropcoin/insight-api-dropcoin#web-socket-api)
* API: [https://github.com/dropcoin/insight-api-dropcoin#swifttx-transactions](https://github.com/dropcoin/insight-api-dropcoin#swifttx-transactions)
...
By default, the DropCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DropCoin Core daemon:
