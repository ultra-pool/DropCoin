Contributing to DropCoin Core
==================================

The DropCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DropCoin Core project, and is not to be
confused with overall DropCoin Network Protocol consensus changes.

Whether a pull request is merged into DropCoin Core rests with the project merge
...
Patches that change DropCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DropCoin consensus, it must have been
...
The project leader is the release manager for each DropCoin Core release.
