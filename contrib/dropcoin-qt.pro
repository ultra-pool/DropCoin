...
RESOURCES += src/qt/dropcoin.qrc src/qt/dropcoin_locale.qrc

TRANSLATIONS += src/qt/locale/dropcoin_bg.ts \
                src/qt/locale/dropcoin_de.ts \
                src/qt/locale/dropcoin_en.ts \
                src/qt/locale/dropcoin_es.ts \
                src/qt/locale/dropcoin_fi.ts \
                src/qt/locale/dropcoin_fr.ts \
                src/qt/locale/dropcoin_it.ts \
                src/qt/locale/dropcoin_ja.ts \
                src/qt/locale/dropcoin_pl.ts \
                src/qt/locale/dropcoin_pt.ts \
                src/qt/locale/dropcoin_ru.ts \
                src/qt/locale/dropcoin_sk.ts \
                src/qt/locale/dropcoin_sv.ts \
                src/qt/locale/dropcoin_vi.ts \
                src/qt/locale/dropcoin_zh_CN.ts \
                src/qt/locale/dropcoin_zh_TW.ts
